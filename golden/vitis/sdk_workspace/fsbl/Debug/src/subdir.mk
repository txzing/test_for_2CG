...
src/%.o: ../src/%.c
	...
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -c -fmessage-length=0 -MT"$@" -Og -IC:/Users/txzing/Desktop/test_for_2cg/golden/vitis/sdk_workspace/system_wrapper/export/system_wrapper/sw/system_wrapper/fsbl_domain/bspinclude/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
