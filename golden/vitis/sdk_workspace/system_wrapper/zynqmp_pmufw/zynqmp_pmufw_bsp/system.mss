...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_passthrough_monitor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = csi_rx_0_axis_passthrough_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = csi_rx_0_axis_switch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipicsiss
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = csi_rx_0_mipi_csi2_rx_subsyst_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = csi_rx_0_v_tpg_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_passthrough_monitor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = csi_rx_1_axis_passthrough_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = csi_rx_1_axis_switch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipicsiss
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = csi_rx_1_mipi_csi2_rx_subsyst_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = v_tpg
 PARAMETER DRIVER_VER = 8.2
 PARAMETER HW_INSTANCE = csi_rx_1_v_tpg_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.7
 PARAMETER HW_INSTANCE = memory_subsystem_axi_vdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.7
 PARAMETER HW_INSTANCE = memory_subsystem_axi_vdma_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_passthrough_monitor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = memory_subsystem_axis_passthrough_mon_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_passthrough_monitor
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = memory_subsystem_axis_passthrough_mon_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_switch
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = memory_subsystem_axis_switch_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = vprocss
 PARAMETER DRIVER_VER = 2.7
 PARAMETER HW_INSTANCE = memory_subsystem_v_proc_ss_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI_LITE_REG
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = processor_subsystem_AXI_LITE_REG_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = tmrctr
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = processor_subsystem_axi_timer_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = processor_subsystem_rs485_hier_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.4
 PARAMETER HW_INSTANCE = processor_subsystem_rs485_hier_axi_uartlite_0
END
...
BEGIN DRIVER
 ...
 PARAMETER DRIVER_VER = 1.3
 PARAMETER HW_INSTANCE = video_out_clk_wiz_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.6
 PARAMETER HW_INSTANCE = xgpio_i2c_0_axi_gpio_0
END
