...
#echo -e "the_ROM_image:\n{\n$top/sdk_workspace/vitis_proj/_ide/bitstream/download.bit\n}\n" > ../flash/bootimage.bif
...
msys*) 
    ...
    FSBLFILE="[bootloader, destination_cpu=a53-0] `cygpath -w ${top}/sdk_workspace/fsbl/Debug/fsbl.elf`"
...
cp ./sdk_workspace/fsbl/Debug/fsbl.elf ./output/fsbl0.elf 
